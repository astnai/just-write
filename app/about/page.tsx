    ...
    <div className="flex flex-col items-center justify-start min-h-screen bg-black text-white">
      ...
      <div className="w-full max-w-2xl mx-auto text-center mt-20 px-4 sm:px-0">
        <div className="text-left sm:p-6 md:p-8 lg:p-10 xl:p-18">
          ...
          <p className="mb-4">
            It lets you write only when dark ambient music plays, simulating the
            author&apos;s emotional relief method.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            Whether journaling, brainstorming, or seeking mental relief, this
            app offers a distraction-free environment.
          </p>
          <p className="mb-4">
            Developed by{" "}
            <Link
